    ...
    const { featured, bestSelling } = (() => {
        ...
        return {
            featured: rangeMap(6, (i) => featuredProducts[i] ?? products.shift())
                ...
                .reverse(),
            bestSelling: rangeMap(6, (i) => bestSellingProducts[i] ?? products.shift()).filter(nonNullable),
        };
    })();
...
export default function Home({
    ...
    return (
        ...
        ‘Natural’."
            ...
            <HomeAllProductsGrid categories={categories} brands={brands} newestProducts={newestProducts} />
        </div>
    );
}
